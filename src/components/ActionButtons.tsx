  ...
  return (
    <div className="shrink-0 mb-8 px-6 flex items-center justify-center gap-5 z-20 relative">
      ...
      <button 
        onClick={onSwipeLeft}
        disabled={disabled}
        className="w-14 h-14 rounded-full bg-surface shadow-card flex items-center justify-center text-text-secondary border border-card-border hover:text-danger hover:border-danger/30 hover:scale-105 active:scale-95 transition-all duration-200 disabled:opacity-30 disabled:pointer-events-none"
      >
      ...
      <div className="relative">
        <button 
          ...
          disabled={disabled}
          className="w-14 h-14 rounded-full bg-surface text-primary shadow-card flex items-center justify-center border border-card-border hover:scale-105 active:scale-95 transition-all duration-200 disabled:opacity-30 disabled:pointer-events-none"
